...
//! ```
//!
//! ## Dynamic Expressions: `42`, `|prop1| prop1 + 1`, etc.
//!
...
//!
//! **Explicit inputs: `|funcinputs...| rust-expr`** —
//! `funcinputs...` is zero or more *inputs* to the expression with optional
//! decorations shown below:
//!
...
//! ```
//!
//! **Inline inputs: `get!(prop1)`** —
//! Instead of separately specifying the list of inputs, they can be defined
//! in-line using `get!`.
//!
//! ```tcwdl,no_compile
//! // The following examples are equivalent to the last ones
