...
impl Prop {
    pub const fn kind_flags(&self) -> PropKindFlags {
        match *self {
            ...
            Prop::SubviewLayouter => PropKindFlags::LAYOUT,
            Prop::SubviewPadding => PropKindFlags::LAYOUT,
            Prop::SubviewMetrics(_) => PropKindFlags::LAYOUT,
            Prop::SubviewTableCell(_) => PropKindFlags::LAYOUT,
            Prop::SubviewTableAlign(_) => PropKindFlags::LAYOUT,
            Prop::SubviewTableColSpacing(_) => PropKindFlags::LAYOUT,
            Prop::SubviewTableRowSpacing(_) => PropKindFlags::LAYOUT,
